...
export const tournamentsApiSlice = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    // NEW: VĐV gửi yêu cầu ghép cặp vào đăng ký đơn (giải đôi) — chờ VĐV 1 duyệt
    ...
    // NEW: VĐV 1 duyệt 1 người xin ghép
    ...
    // ✅ Admin/manager duyệt registration từ waitlist → approved
